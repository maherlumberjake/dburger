	...
	return (
		<div className="burgerDetails grid grid-cols-1 sm:grid-cols-2 gap-4 p-4 pt-20">
			...
			<div className=" grid grid-cols-2 justify-between items-center gap-4">
				...
				<h3 className="text-xl sm:text-2xl text-yellow-500">Descreption :</h3>
				...
				<div className=" col-span-2  flex gap-4">
					...
					/>
					<button className=" transition-transform hover:scale-105 border-current text-yellow-500 border-2 p-y px-2 font-bold rounded-md w-1/3 ">
						send
					</button>
